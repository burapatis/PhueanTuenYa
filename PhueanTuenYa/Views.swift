                    ...
                    VStack(alignment: .leading, spacing: 14) {
                        ...
                        AppCard(tint: .calendarTint) {
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                Text("เวอร์ชัน v0.6.5 • พร้อมเตรียม TestFlight และทดสอบผู้ใช้กลุ่มเล็ก")
                                    .font(.headline.weight(.semibold))
                                    .foregroundStyle(Color.appSubtext)
                        ...
                        AppCard(tint: .appBlue.opacity(0.18)) {
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                Text("ใช้ v0.6.5 เป็นชุดเตรียมอัปโหลดให้ผู้ทดสอบผ่าน TestFlight หลังทดสอบบน iPhone จริงผ่านแล้ว")
                                    .font(.subheadline.weight(.semibold))
                                    .foregroundStyle(Color.appSubtext)
                                CompactCheckRow(text: "ตั้ง Bundle Identifier และ Signing ให้ถูกต้อง")
                                CompactCheckRow(text: "ตั้ง Version เป็น 0.6.5 และ Build number ใหม่ก่อน Archive")
